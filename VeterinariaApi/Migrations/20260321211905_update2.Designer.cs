...
namespace VeterinariaApi.Migrations
{
    ...
    [Migration("20260321211905_update2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VeterinariaApi.Models.ConsumoAlimento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VeterinariaApi.Models.Dueños", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VeterinariaApi.Models.EspecieMascota", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("NombreEspecie")
                        .IsUnique();

                    b.ToTable("EspecieMascotas");
                });
            ...
            modelBuilder.Entity("VeterinariaApi.Models.RazaMascota", b =>
                {
                    ...
                    b.Property<int>("IdEspecieMascota")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VeterinariaApi.Models.TipoAlimentacion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VeterinariaApi.Models.TipoDocumentos", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VeterinariaApi.Models.Clientes", b =>
                {
                    b.HasOne("VeterinariaApi.Models.Ciudad", "Ciudad")
                        .WithMany()
                    ...
                    b.HasOne("VeterinariaApi.Models.TipoCliente", "TipoCliente")
                        .WithMany()
            ...
            modelBuilder.Entity("VeterinariaApi.Models.Dueños", b =>
                {
                    ...
                    b.HasOne("VeterinariaApi.Models.TipoDocumentos", "TipoDocumento")
                        .WithMany()
            ...
            modelBuilder.Entity("VeterinariaApi.Models.RazaMascota", b =>
                {
                    b.HasOne("VeterinariaApi.Models.EspecieMascota", "EspecieMascota")
                        .WithMany()
                        .HasForeignKey("IdEspecieMascota")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
